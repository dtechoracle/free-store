            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://media.istockphoto.com/id/1456133856/photo/close-up-shot-of-females-hand-holding-credit-card-using-smartphone-shopping-and-paying-online.jpg?s=612x612&w=0&k=20&c=umyzaWxidfa680znZxbweRzpXC6FR86pgPP3JQNZKHk="
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  ...
                  <span className="block text-indigo-200">products and suggestions</span>
                </h1>
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div className="mx-auto max-w-xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">Enjoy quality products</h2>
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="-mr-48 pl-4 sm:pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                  <img
                    ...
                    src="https://media.istockphoto.com/id/1333948679/photo/online-shop-worker-scanning-information-on-the-product-package.jpg?s=612x612&w=0&k=20&c=izQntLOAZ85FMGzPAoLfkJFV4NvBP23hSpq9wi5IZO0="
              ...
              <div className="mt-12 sm:mt-16 lg:col-start-1 lg:mt-0">
                <div className="-ml-48 pr-4 sm:pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                  <img
                    ...
                    src="https://cdn.dribbble.com/users/1977127/screenshots/12004437/output.png"
